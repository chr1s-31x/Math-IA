...
class FourierSeries(object):
    ...
    def __init__(self, fileName, integrationRule):
    ...
    def Integrate(func, begin, end, args):
        ...
        i, harmonic, xVec, yVec, period = args
    ...
    def findFTC(self, points, n=0):
        ...
        #    tempVec[i] = FourierSeries.integrand(tempX[i], 0, npy.cos, points[2], points[0], period)
        ...
        a0_x = invP * FourierSeries.Integrate(FourierSeries.integrand, begin, end,
                                             args=(0, npy.cos, points[2], points[0], period))
        ...
        for i in range(1, n):
            A_y[i - 1] = invP * FourierSeries.Integrate(FourierSeries.integrand, begin, end,
                                                       args=(i, npy.cos, points[2], points[1], period))
            B_y[i - 1] = invP * FourierSeries.Integrate(FourierSeries.integrand, begin, end,
                                                       args=(i, npy.sin, points[2], points[1], period))
...
if __name__ == '__main__':
    ...
    fileName ='/home/superadmin/newIB.txt'
    fs = FourierSeries(fileName, 'trapezoidal')
    fs.Invoke()
